...
public class LockerControllerTest extends BaseControllerTest {
    ...
    @Nested
    class CheckingWhetherThereIsAvailableSlot extends BaseControllerTest {
        @Test
    ...
    @Nested
    class GettingAvailableSlotToSavePackage extends BaseControllerTest {
    ...
    @Nested
    class GettingOccupiedSlotBeforeToTakePackageBack extends BaseControllerTest {
